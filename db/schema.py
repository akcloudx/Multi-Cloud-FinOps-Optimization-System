...
class CloudTenant(Base):
    ...
    # caption, same as before this feature existed. Database Savings Plans
    # are 1-year-term-only (confirmed via AWS's own Savings Plans FAQ,
    # unlike Compute/SageMaker which offer 1yr and 3yr), hence only one
    # database column below - matches the Database pool tab's existing
    # available_terms=("1yr",) restriction in app.py.
    ...
    aws_sp_database_discount_1yr  = Column(Float, nullable=True)
